...
def main():
    ...
    parser.add_argument('-m', '--mode', required=True, choices=[to_s3, to_jdbc],
                        help='Choose to migrate from datacatalog to s3 or to metastore')
    parser.add_argument('--database-names', required=True,
                        help='Colon-separated list of names of database in Datacatalog to export')
...
if __name__ == '__main__':
    logger.info('Loading Glue Jub {}'.format(__name__))
    main()
